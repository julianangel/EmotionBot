...
public:
	...
	virtual theatrebot_action_modulation::ActionExecutionActionDescriptionMessage getMessage()=0;
	...
	void setTypeAction(TypeAction type_action);
	TypeActionEmotionChange getTypeEmotiveAction();
	void setTypeEmotiveAction(TypeActionEmotionChange type_emotion_changes);
...
protected:
	...
	/*
	 * Tell the type of emotion changes that should be done
	 */
	TypeActionEmotionChange type_emotion_changes;
	/**
	 * name of the action that represents
	 */
	string action_name;
	/*
	 * tell if the other actions are coordinated in base of this one
	 */
