...
#ifndef OLDWALKCOMPOUNDACTION_H_
#define OLDWALKCOMPOUNDACTION_H_
...
class OldWalkCompoundAction:  public SequenceAbstractActionDescription{
public:
	OldWalkCompoundAction();
	virtual ~OldWalkCompoundAction();
