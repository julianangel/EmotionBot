...
#include "../instance_simple_action_description/MoveTorsoSimpleAction.h"
...
private:
	...
	shared_ptr<PointPositionParameter> parameter_position_shoulder;
	shared_ptr<PointPositionParameter> parameter_position_torso;
	/**
	...
	shared_ptr<MoveTorsoSimpleAction> move_torso_simple_action;
