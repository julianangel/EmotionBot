#ifndef _ROS_theatrebot_action_modulation_Quaternion32_h
#define _ROS_theatrebot_action_modulation_Quaternion32_h
...
namespace theatrebot_action_modulation
{
  ...
  class Quaternion32 : public ros::Msg
  {
    ...
    const char * getType(){ return "theatrebot_action_modulation/Quaternion32"; };
