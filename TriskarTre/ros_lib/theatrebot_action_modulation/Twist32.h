#ifndef _ROS_theatrebot_action_modulation_Twist32_h
#define _ROS_theatrebot_action_modulation_Twist32_h
...
namespace theatrebot_action_modulation
{
  ...
  class Twist32 : public ros::Msg
  {
    ...
    const char * getType(){ return "theatrebot_action_modulation/Twist32"; };
