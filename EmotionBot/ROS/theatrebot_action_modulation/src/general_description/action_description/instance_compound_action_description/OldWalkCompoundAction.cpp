...
list<shared_ptr<SimpleActionExecution> > OldWalkCompoundAction::Analyze(){
...
void OldWalkCompoundAction::setParameterPosition(shared_ptr<ParameterPosition> parameter_destination){
	this->parameter_destination = parameter_destination;
	this->move_body_simple_action->setParameterPosition(parameter_destination);
}

shared_ptr<ParameterPosition> OldWalkCompoundAction::getParameterPosition(){
	return this->parameter_destination;
}
void OldWalkCompoundAction::setParameterTrnaslation(shared_ptr<ParameterTranslation> parameter_translation){
	this->parameter_translation = parameter_translation;
	this->move_body_simple_action->setParameterTrnaslation(parameter_translation);
...
void OldWalkCompoundAction::reduceTranslationParameterShoulder(){
...
shared_ptr<ParameterTranslation> OldWalkCompoundAction::getParameterTranslation(){

	return this->parameter_translation;
}
float OldWalkCompoundAction::getShoulderReduceFactor(){
	return this->reduce_factor_shoulder;
}
void OldWalkCompoundAction::setShoulderReduceFactor(float reduce_factor){
