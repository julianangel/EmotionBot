...
/*
 * Remember that all the action should have the same division, this means that if an action as 4 changes in the emotion description,
 * the other actions should have the same amount of changes
 */
void EmotionTest1::createMoveHappy(){
	...
	emotion_parameter.reset(new EmotionParameter);
	emotion_parameter->setEmotionParameterTime(1);
